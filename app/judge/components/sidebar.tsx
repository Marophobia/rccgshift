    ...
    return (
        ...
        >
            <div className="px-4 h-header flex items-center shrink-0 group-data-[sidebar-size=sm]:px-2 group-data-[sidebar-size=sm]:justify-center">
                <a href="/admin" className="group-data-[sidebar-size=lg]:block hidden">
                    <img src="/images/logo/logo-text.svg" alt="logo" className="group-data-[theme-mode=dark]:hidden" />
                    <img src="/images/logo/logo-text-dark.svg" alt="logo" className="group-data-[theme-mode=light]:hidden" />
                </a>
                <a href="/admin" className="group-data-[sidebar-size=lg]:hidden block">
