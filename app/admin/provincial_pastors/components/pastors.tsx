...
type Props = {
    pastors: IprovincialPastors[];
};

const ProvincialPastorsTable = ({ pastors }: Props) => {
    ...
    const deleteEntry = async (id: number) => {
        try {
            const update = await fetch(
                `${apiUrl}/api/admin/pastors/provincial/actions/delete`,
                {
                    method: 'POST',
                    cache: 'no-store',
    ...
    const downloadPDF = () => {
        ...
        const tableColumn = [
            ...
            'Province',
            'Phone',
            'Provincial Shifh Coord Name',
            'Provincial Shift Coord Phone',
            'Date',
        ];
        const tableRows: any[] = [];
        ...
        doc.save('provincialshiftcoord.pdf');
        setLoading(false)
    };
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead>PS coordinator</TableHead>
                            <TableHead>PS coordinator phone</TableHead>
...
export default ProvincialPastorsTable;
