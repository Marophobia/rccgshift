        ...
        <>
            <div className="col-span-full 2xl:col-span-4 card">
                <div className="flex-center-between">
                    ...
                    <Link href="/admin/contestants" className="btn b-solid btn-primary-solid btn-sm">
                        See all
                    </Link>
                </div>
                {/* Course Table */}
                            ...
                            {data.map(contestant => (
                                <tr key={contestant.id}>
                                    <td className="flex items-center gap-2 px-3.5 py-4">
                                        <a href="#" className="size-10 rounded-50 overflow-hidden">
                                            <img
                                    ...
                                    <td className="px-3.5 py-4">{contestant.category}</td>
                                    <td className="px-3.5 py-4">{contestant.region}</td>
                                    <td className="px-3.5 py-4">{contestant.status}</td>
                                </tr>
                            ))}
